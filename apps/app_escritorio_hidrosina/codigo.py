...
def obtener_dfsucio(excel_path):
    ...
    dfsucio=pd.read_excel(excel_path, skiprows=[0,1])
...
def obtener_df ( df_sucio ):
    df=df_sucio.copy()
    df=df[['Unnamed: 0', 'Unnamed: 4','Unnamed: 8','Unnamed: 11','Unnamed: 15','Unnamed: 19','Unnamed: 22','Unnamed: 28','Unnamed: 34','Unnamed: 39']]
    df.rename(columns={'Unnamed: 0':'Núm. Tarjeta', 'Unnamed: 4':'Placas','Unnamed: 8': 'Fecha/ Hora','Unnamed: 11':'No.Trx','Unnamed: 15':'Producto','Unnamed: 19':'Precio Unitario ','Unnamed: 22':'Litros','Unnamed: 28':'Importe','Unnamed: 34':'IVA','Unnamed: 39':'Total'}, inplace= True)
